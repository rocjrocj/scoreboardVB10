...
{
    public class ScoreboardVBModels1Controller : Controller
    {
        private ApplicationDbContext db = new ApplicationDbContext();

        // GET: ScoreboardVBModels1
        public ActionResult Index()
        {
            return View(db.ScoreboardVBModels.ToList());
        }

        // GET: ScoreboardVBModels1/Details/5
        ...
        // GET: ScoreboardVBModels1/Create
        public ActionResult Create()
        {
            return View();
        }

        // POST: ScoreboardVBModels1/Create
        ...
        // GET: ScoreboardVBModels1/Edit/5
        ...
        // POST: ScoreboardVBModels1/Edit/5
        // To protect from overposting attacks, please enable the specific properties you want to bind to, for 
        // more details see https://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        ...
        // GET: ScoreboardVBModels1/Delete/5
        ...
        // POST: ScoreboardVBModels1/Delete/5
